$(function () {
    ...
    function n() {
        ...
        var t = $(this).attr("href"), a = $(this).data("index"),m_id = $(this).data("menu-id"), i = $.trim($(this).text()), n = !0;
        ...
        if ($(".J_menuTab").each(function () {
            ...
            var r = '<iframe class="J_iframe" name="iframe' + a + '" width="100%" height="100%" src="' + t + '?v=4.0&t=' + c_t + '" frameborder="0" data-id="' + t + '" seamless></iframe>';
            //$(".J_mainContent").find("iframe.J_iframe").hide().parents(".J_mainContent").html(r);
            $(".J_mainContent").empty().html(r);
            //$(".J_mainContent").empty().html(t);



            //更改地址栏地址
            history.pushState({}, '', '#'+t);
            //history.pushState({}, '', "/html/" + t.split("#")[0]);
