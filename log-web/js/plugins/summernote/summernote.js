...
(function (factory) {
  ...
  var editor = renderer.create('<div class="note-editor note-frame panel panel-default" style="width:600px;"/>');
  ...
  var dropdown = renderer.create('<div class="dropdown-menu">', function ($node, options) {
    var markup = $.isArray(options.items) ? options.items.map(function (item) {
      ...
      return '<li><a href="#" data-event="formatBlock" data-value="' + item + '">' + des + '</a></li>';
    }).join('') : options.items;
  ...
  var Editor = function (context) {
    ...
    this.insertImage = function (sUrl, filename) {
      return async.createImage(sUrl, filename).then(function ($image) {
        ...
        $image.css({
          display: '',
          width: '50%' //Math.min($editable.width(), $image.width())
        });
  ...
  $.summernote = $.extend($.summernote, {
    ...
    options: {
      ...
      icons: {
        ...
        'indent': 'icon icon-indent-left',
        'outdent': 'icon icon-indent-right',
