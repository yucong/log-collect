...
public class SmsSendLogDao extends BaseDao<SmsSendLog> {
	...
	private static final String COLLECTION_NAME = "smsSendLog";
    ...
    public DataTableVO<SmsSendLog> listAll(ListSmsSendLogDTO dto) {
        ...
        List<SmsSendLog> list = mongoTemplate.find(query, SmsSendLog.class,COLLECTION_NAME);
    	return new DataTableVO<SmsSendLog>(size, allCount, allPage, currentPage, list);
    }
